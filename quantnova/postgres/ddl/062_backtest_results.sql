...
CREATE TABLE IF NOT EXISTS quantnova.backtest_results (
    ...
    CONSTRAINT backtest_results_backtest_fk FOREIGN KEY (backtest_id) REFERENCES quantnova.backtests (id) ON DELETE CASCADE
);
