...
CREATE TABLE IF NOT EXISTS quantnova.broker_accounts (
    ...
    CONSTRAINT broker_accounts_user_fk FOREIGN KEY (user_id) REFERENCES shared.users (id) ON DELETE CASCADE,
    CONSTRAINT broker_accounts_broker_fk FOREIGN KEY (broker_id) REFERENCES quantnova.brokers (id) ON DELETE RESTRICT,
