...
CREATE TABLE IF NOT EXISTS quantnova.drift_detection (
    ...
    CONSTRAINT drift_detection_model_fk FOREIGN KEY (model_id) REFERENCES quantnova.ml_models (id) ON DELETE CASCADE
);
