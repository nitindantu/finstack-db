...
CREATE TABLE IF NOT EXISTS quantnova.positions (
    ...
    CONSTRAINT positions_broker_account_fk FOREIGN KEY (broker_account_id) REFERENCES quantnova.broker_accounts (id) ON DELETE CASCADE,
    CONSTRAINT positions_symbol_fk FOREIGN KEY (symbol_id) REFERENCES screenerx.symbols (id) ON DELETE RESTRICT,
