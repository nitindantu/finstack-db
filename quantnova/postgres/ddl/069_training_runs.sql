...
CREATE TABLE IF NOT EXISTS quantnova.training_runs (
    ...
    CONSTRAINT training_runs_model_fk FOREIGN KEY (model_id) REFERENCES quantnova.ml_models (id) ON DELETE CASCADE,
