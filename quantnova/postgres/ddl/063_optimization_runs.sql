...
CREATE TABLE IF NOT EXISTS quantnova.optimization_runs (
    ...
    CONSTRAINT optimization_runs_strategy_fk FOREIGN KEY (strategy_id) REFERENCES quantnova.strategies (id) ON DELETE CASCADE
);
