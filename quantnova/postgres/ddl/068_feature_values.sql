...
CREATE TABLE IF NOT EXISTS quantnova.feature_values (
    ...
    CONSTRAINT feature_values_symbol_fk FOREIGN KEY (symbol_id) REFERENCES screenerx.symbols (id) ON DELETE CASCADE,
    CONSTRAINT feature_values_feature_fk FOREIGN KEY (feature_id) REFERENCES quantnova.feature_store (id) ON DELETE CASCADE
);
