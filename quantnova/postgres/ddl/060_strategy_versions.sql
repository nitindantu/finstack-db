...
CREATE TABLE IF NOT EXISTS quantnova.strategy_versions (
    ...
    CONSTRAINT strategy_versions_strategy_fk FOREIGN KEY (strategy_id) REFERENCES quantnova.strategies (id) ON DELETE CASCADE,
