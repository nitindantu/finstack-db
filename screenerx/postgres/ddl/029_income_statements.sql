...
CREATE TABLE IF NOT EXISTS screenerx.income_statements (
    ...
    CONSTRAINT income_statements_company_fk FOREIGN KEY (company_id) REFERENCES screenerx.companies (id) ON DELETE CASCADE,
