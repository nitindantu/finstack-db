...
CREATE TABLE IF NOT EXISTS screenerx.cash_flows (
    ...
    CONSTRAINT cash_flows_company_fk FOREIGN KEY (company_id) REFERENCES screenerx.companies (id) ON DELETE CASCADE,
