...
CREATE TABLE IF NOT EXISTS screenerx.market_data_ticks (
    ...
    CONSTRAINT market_data_ticks_symbol_fk FOREIGN KEY (symbol_id) REFERENCES screenerx.symbols (id) ON DELETE CASCADE,
