...
CREATE TABLE IF NOT EXISTS screenerx.institutional_holdings (
    ...
    CONSTRAINT institutional_holdings_company_fk FOREIGN KEY (company_id) REFERENCES screenerx.companies (id) ON DELETE CASCADE,
