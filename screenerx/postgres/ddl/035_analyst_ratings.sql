...
CREATE TABLE IF NOT EXISTS screenerx.analyst_ratings (
    ...
    CONSTRAINT analyst_ratings_company_fk FOREIGN KEY (company_id) REFERENCES screenerx.companies (id) ON DELETE CASCADE
);
