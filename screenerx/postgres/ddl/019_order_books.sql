...
CREATE TABLE IF NOT EXISTS screenerx.order_books (
    ...
    CONSTRAINT order_books_symbol_fk FOREIGN KEY (symbol_id) REFERENCES screenerx.symbols (id) ON DELETE CASCADE
);
