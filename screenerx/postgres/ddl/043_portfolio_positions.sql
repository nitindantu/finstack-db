...
CREATE TABLE IF NOT EXISTS screenerx.portfolio_positions (
    ...
    CONSTRAINT portfolio_positions_portfolio_fk FOREIGN KEY (portfolio_id) REFERENCES screenerx.portfolios (id) ON DELETE CASCADE,
    CONSTRAINT portfolio_positions_symbol_fk FOREIGN KEY (symbol_id) REFERENCES screenerx.symbols (id) ON DELETE RESTRICT,
