...
CREATE TABLE IF NOT EXISTS screenerx.screener_executions (
    ...
    CONSTRAINT screener_executions_user_fk FOREIGN KEY (user_id) REFERENCES shared.users (id) ON DELETE CASCADE,
    CONSTRAINT screener_executions_screener_fk FOREIGN KEY (screener_id) REFERENCES screenerx.saved_screeners (id) ON DELETE SET NULL
);
