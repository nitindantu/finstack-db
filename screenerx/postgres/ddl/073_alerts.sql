...
CREATE TABLE IF NOT EXISTS screenerx.alerts (
    ...
    CONSTRAINT alerts_user_fk FOREIGN KEY (user_id) REFERENCES shared.users (id) ON DELETE CASCADE,
    CONSTRAINT alerts_symbol_fk FOREIGN KEY (symbol_id) REFERENCES screenerx.symbols (id) ON DELETE CASCADE
);
