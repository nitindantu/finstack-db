...
CREATE TABLE IF NOT EXISTS screenerx.instrument_master (
    ...
    CONSTRAINT instrument_master_symbol_fk FOREIGN KEY (symbol_id) REFERENCES screenerx.symbols (id) ON DELETE CASCADE
);
