...
CREATE TABLE IF NOT EXISTS screenerx.balance_sheets (
    ...
    CONSTRAINT balance_sheets_company_fk FOREIGN KEY (company_id) REFERENCES screenerx.companies (id) ON DELETE CASCADE,
