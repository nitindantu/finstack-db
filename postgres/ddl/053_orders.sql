...
CREATE TABLE IF NOT EXISTS orders (
    ...
    CONSTRAINT orders_portfolio_fk FOREIGN KEY (portfolio_id) REFERENCES portfolios (id) ON DELETE SET NULL,
    CONSTRAINT orders_broker_account_fk FOREIGN KEY (broker_account_id) REFERENCES broker_accounts (id) ON DELETE SET NULL,
    CONSTRAINT orders_symbol_fk FOREIGN KEY (symbol_id) REFERENCES symbols (id) ON DELETE RESTRICT,
    CONSTRAINT orders_parent_fk FOREIGN KEY (parent_order_id) REFERENCES orders (id) ON DELETE SET NULL,
