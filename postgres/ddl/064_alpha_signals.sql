...
CREATE TABLE IF NOT EXISTS alpha_signals (
    ...
    CONSTRAINT alpha_signals_symbol_fk FOREIGN KEY (symbol_id) REFERENCES symbols (id) ON DELETE CASCADE,
    CONSTRAINT alpha_signals_strategy_fk FOREIGN KEY (strategy_id) REFERENCES strategies (id) ON DELETE CASCADE,
