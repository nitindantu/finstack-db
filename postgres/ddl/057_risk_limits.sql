...
CREATE TABLE IF NOT EXISTS risk_limits (
    ...
    CONSTRAINT risk_limits_user_fk FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE,
    CONSTRAINT risk_limits_portfolio_fk FOREIGN KEY (portfolio_id) REFERENCES portfolios (id) ON DELETE CASCADE
);
