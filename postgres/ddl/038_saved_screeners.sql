...
CREATE TABLE IF NOT EXISTS saved_screeners (
    ...
    CONSTRAINT saved_screeners_user_fk FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE,
    CONSTRAINT saved_screeners_template_fk FOREIGN KEY (template_id) REFERENCES screener_templates (id) ON DELETE RESTRICT,
