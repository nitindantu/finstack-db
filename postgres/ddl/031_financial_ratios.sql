...
CREATE TABLE IF NOT EXISTS financial_ratios (
    ...
    CONSTRAINT financial_ratios_company_fk FOREIGN KEY (company_id) REFERENCES companies (id) ON DELETE CASCADE,
    CONSTRAINT financial_ratios_symbol_fk FOREIGN KEY (symbol_id) REFERENCES symbols (id) ON DELETE CASCADE,
