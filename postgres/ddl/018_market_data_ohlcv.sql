...
CREATE TABLE IF NOT EXISTS market_data_1m (
    ...
    CONSTRAINT market_data_1m_symbol_fk FOREIGN KEY (symbol_id) REFERENCES symbols (id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS market_data_5m (
    ...
    CONSTRAINT market_data_5m_symbol_fk FOREIGN KEY (symbol_id) REFERENCES symbols (id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS market_data_15m (
    ...
    CONSTRAINT market_data_15m_symbol_fk FOREIGN KEY (symbol_id) REFERENCES symbols (id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS market_data_1h (
    ...
    CONSTRAINT market_data_1h_symbol_fk FOREIGN KEY (symbol_id) REFERENCES symbols (id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS market_data_1d (
    ...
    CONSTRAINT market_data_1d_symbol_fk FOREIGN KEY (symbol_id) REFERENCES symbols (id) ON DELETE CASCADE,
