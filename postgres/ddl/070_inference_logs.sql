...
CREATE TABLE IF NOT EXISTS inference_logs (
    ...
    CONSTRAINT inference_logs_model_fk FOREIGN KEY (model_id) REFERENCES ml_models (id) ON DELETE CASCADE,
    CONSTRAINT inference_logs_symbol_fk FOREIGN KEY (symbol_id) REFERENCES symbols (id) ON DELETE CASCADE
);
