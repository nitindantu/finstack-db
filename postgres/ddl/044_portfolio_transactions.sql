...
CREATE TABLE IF NOT EXISTS portfolio_transactions (
    ...
    CONSTRAINT portfolio_transactions_portfolio_fk FOREIGN KEY (portfolio_id) REFERENCES portfolios (id) ON DELETE CASCADE,
    CONSTRAINT portfolio_transactions_symbol_fk FOREIGN KEY (symbol_id) REFERENCES symbols (id) ON DELETE RESTRICT
);
