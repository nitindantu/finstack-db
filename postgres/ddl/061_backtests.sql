...
CREATE TABLE IF NOT EXISTS backtests (
    ...
    CONSTRAINT backtests_strategy_fk FOREIGN KEY (strategy_id) REFERENCES strategies (id) ON DELETE CASCADE,
    CONSTRAINT backtests_user_fk FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE,
