...
CREATE TABLE IF NOT EXISTS billing_transactions (
    ...
    CONSTRAINT billing_transactions_user_fk FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE RESTRICT,
    CONSTRAINT billing_transactions_subscription_fk FOREIGN KEY (subscription_id) REFERENCES subscriptions (id) ON DELETE SET NULL,
